...
<html>
	...
	<body class="main">
		<% try {
			...
			String alertsql = "SELECT Sent_Time, Message FROM Alert LEFT JOIN ON alert.username = buyer.username WHERE Sent_Time> last_read_time AND Username = '"+username+"';";
			...
			//TODO: add insert statement to Item_Alert_Manager in new page
