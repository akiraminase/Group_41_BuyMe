...
<html>
	...
	<body class="main">
		...
		try {
			...
			String str = "select q.description as Question,a.description as Answer,a.customer_representative from Question q, Answer A where q.question_id = a.question_id AND "+
						"(q.description LIKE '%"+keyword+"%' OR a.description LIKE '%"+keyword+"%' );";
